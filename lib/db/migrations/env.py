...
# Import your model's Base with correct path
from models import Base

# Provide MetaData for 'autogenerate'
target_metadata = Base.metadata

# Optionally override the sqlalchemy.url from alembic.ini
config.set_main_option("sqlalchemy.url", "sqlite:///lib/db/app.db")
